                            ...
                            <form id="register" method="post" action="index.html">
                                ...
                                <div class="form-row col-sm-6 col-md-12 col-lg-12">
                                    <div class="form-group col-md-5 ">
                                        ...
                                        */
                                        ...
                                        //$output = " ";
                                        //if(isset($_POST['emailoReg']))
                                        //{
                                            echo utf8_decode($_POST['emailoReg']);
                                          //  $output .= 'email='.$_POST['emailoReg'];
                                        //}

                                        die($output); //Enviamos la respuesta y finalizamos el script.
                                        ?>
                                ...
                                <div class="form-row col-sm-6 col-md-12 col-lg-12">
                                    <div class="form-row col-sm-6 col-md-6 col-lg-6">
                                        ...
                                        <div class="form-group col-md-2 col-lg-3">
                                            ...
                                            <input type="text" class="form-control is-valid" id="ape1" name="ape1" required>
                                        ...
                                        <div class="form-group col-md-2 col-lg-3">
                                            ...
                                            <input type="text" class="form-control is-valid" id="ape2" name="ape2">
                                        ...
                                        <div class="form-group col-md-2 col-lg-3">
                                            ...
                                            <input type="text" class="form-control is-valid" id="zipo" name="zipo" placeholder="01000" required>
                                ...
                                <div class="form-row col-sm-6 col-md-12 col-lg-12">
                                    ...
                                    <div class="form-group col-md-2 col-lg-2" >
                                        ...
                                        <input type="text" class="form-control is-valid" id="dni" name="dni" pattern="[a-zA-Z0-9]{5,10}$" required>
